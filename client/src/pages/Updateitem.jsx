...
<div>
      ...
      <h1 className="text-center text-4xl my-7 font-extralight text-black">Update Items</h1>
        ...
        {[0, 1, 2].map((index) => (
          ...
          >
            <input
              ...
              className="border border-gray-300 bg-white  rounded-md py-2 px-4 focus:outline-none focus:border-green-600"
            />
