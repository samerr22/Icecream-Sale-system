  ...
  const handleDeleteUser = async () => {
    try {
      const res = await fetch(
        `http://localhost:3000/api/items/deleteitem/${ItemDelete}`,
        {
          method: "DELETE",
        }
      );
  ...
  return (
    <div>
      <div className="h-[600px] relative">
        ...
        <div className="flex justify-center items-center text-xl mt-4 font-serif  ml-40"><h1>Mange all items</h1></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex justify-center items-center gap-14 mt-5">
          ...
          <div className="w-[1200px] h-[500px]  ml-48 rounded-lg border border-white bg-slate-100">
