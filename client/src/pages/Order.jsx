        ...
        <div className="h-[600px] relative">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex justify-center items-center gap-14 mt-5">
            <div>
              ...
              <div className=" flex justify-center items-center mt-2 mb-4 text-xl font-serif"><h1>Order History</h1></div>
                

            <div className="max-h-[450px] overflow-y-auto">
              {filteredOrderDetailsList.length > 0 ? (
                filteredOrderDetailsList.map((order, index) => (
                  <div key={index} className="ml-20 bg-white bg-opacity-20 border h-[450px] w-[800px] rounded-lg border-white mb-14">
                    ...
                    <div>
                      ...
                      {order.items.map((item, itemIndex) => (
                        <div key={itemIndex}>
                          ...
                          <hr className="h-1 bg-green-700 w-full" />
                        </div>
                      ))}
                    </div>
                  </div>
