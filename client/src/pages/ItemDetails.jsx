              ...
              {items ? (
                <>
                  <div className="flex justify-center gap-10 ">
                    ...
                    <div className="ml-10">
                      <h1 className="max-w-xs break-words font-serif text-black text-2xl">
                        {items.ItemsN}
                      </h1>
                      <hr className="h-10" />
                      ...
                      <h1 className="mt-5 text-2xl font-extralight text-black">
                        Rs.{items.price}
                      </h1>
                      <div className="flex mt-10">
                        <div
                          className="w-[30px] border border-white bg-green-700 rounded-md flex justify-center items-center  cursor-pointer "
                          onClick={decrement}
                        >
                        ...
                        <div
                          className="w-[30px]  border border-black bg-green-700 rounded-md   flex justify-center items-center cursor-pointer "
                          onClick={increment}
                        >
                      ...
                      {currentUser ? (
                        <button
                          className="bg-green-700 hover:text-black text-white font-extralight py-2 px-20 mt-8 border border-white  rounded-lg"
                          onClick={addToCart}
                        >
                          Add to Cart
                        </button>
                        ...
                        <button
                          className="bg-green-700 hover:opacity-45 text-white font-bold py-2 px-12 mt-5 rounded"
                      ...
                      {notification && (
                        <>
                          ...
                          <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50">
                            <div>
                              <div>
                                <h1 className="text-black bg-red-500 bg-opacity-60 flex justify-center  items-cente text-center py-20 px-28 rounded-xl font-extralight text-3xl">
                                  {notification}
                                </h1>
                              </div>
                            </div>
                  ...
                  <div className="mt-5 mb-5 ml-10">
                    ...
                    <h1 className="max-w-[1200px]  text-black break-words text-sm ">
                      {items.Description}
                    </h1>
                  </div>
                </>
