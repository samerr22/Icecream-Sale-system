  ...
  return (
    <div className={`dropdown-menu ${isOpen ? "visible" : "hidden"}`}>
      <div className="absolute z-50">
        <div className="bg-white rounded-lg shadow-xl absolute lg:w-96 lg:ml-[-180px] lg:h-[500px] ml-[-200px] w-[260px] h-[550px] ">
          {items ? (
            <>
                ...
                {items.map((item) => (
                  ...
                  >
                    <div className="flex justify-center items-center gap-4 ">
                      ...
                      <button
                      className="ml-4 bg-green-700 rounded-full hover:text-black text-white font-extralight py-1 px-2"
                        onClick={() => {
                          setitemsId(item._id);
                          handleDeleteUser();
                        }}
              ...
              <div className="flex justify-center items-center gap-20 mt-4">
                <h1 className="font-extralight text-black text-md">Number of itmes</h1>
                <p className="font-extralight text-black text-md"> Rs.{totalPrice}</p>
              </div>
              ...
              <div className="flex justify-center items-center">
                <button
                  className=" bg-green-700 rounded-full mt-4 hover:text-black text-white font-extralight py-1 px-4"
