  ...
  return (
    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white  border border-green-700  shadow-lg rounded-lg p-4 text-white  z-50">
          <div className="overflow-y-auto max-h-[350px] w-[1000px]">
            <div className="mb-4">
              ...
              {items.map((item, index) => (
                ...
                <div className="mt-4" key={index}>
                  ...
                  <p className="font-serif text-black">{item.ItemsN}</p>
                  </div>
                  <div className="flex justify-center items-center ">
                  <p className="text-black">Quantity: {item.quantity}</p>
                  </div>
                  <div className="flex items-center justify-center text-sm">
                    <p className="text-black">Price: Rs.{item.price}</p>
                    
                  </div>
                  <hr className=" bg-green-700 w-full" />
                </div>
              ...
              <div className="mt-4  ">
                <div className="flex justify-center items-center">
                <input
                  className=" bg-slate-200 shadow-md text-black shadow-black border border-slate-100 p-3 rounded-lg w-[460px] h-11 mb-4"
                  type="text"
          ...
          <div className=" text-center">
            ...
            <div className="flex justify-center items-center gap-6 mt-6 ">
              <button
                type="submit"
                className="bg-green-700 hover:text-black text-white font-extralight py-2 px-4 border border-white  rounded-lg"
              >
                submit
              </button>
